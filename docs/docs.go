    ...
    "paths": {
        "/api/v1/applications": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "ApplicationsDto Data",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/v1.ApplicationsDto"
                        }
                    },
                    {
                        "type": "string",
        ...
        "/api/v1/companies": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "boolean",
                        "description": "Loads RepositoriesDto",
        ...
        "/api/v1/companies/{id}/repositories": {
            ...
            "put": {
                ...
                "parameters": [
                    {
                        "description": "RepositoriesDto data",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/v1.RepositoriesDto"
                        }
                    },
                    {
                        "type": "string",
